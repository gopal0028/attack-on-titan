import { b as resolveElements, r as reactExports, j as jsxRuntimeExports, A as AnimatePresence, m as motion } from "./index-B5x8QOC7.js";
const thresholds = {
  some: 0,
  all: 1
};
...
const SMOKE = "radial-gradient(ellipse at 30% 70%, rgba(0,0,0,0.7) 0%, transparent 70%),radial-gradient(ellipse at 80% 20%, rgba(0,0,0,0.5) 0%, transparent 60%)";
function scene(gradient) {
...
const TIMELINE_ITEMS = [
  ...
  },
  {
    ...
    narration: "They came from every corner of the Walls — orphans, idealists, the desperate, and the disguised. In the brutal training camps of the 104th Cadet Corps, recruits were broken and rebuilt under an unforgiving curriculum. Eren, Mikasa, and Armin trained alongside Annie, Reiner, Bertholdt, and Connie, forging bonds over shared exhaustion and shared nightmares. None of them knew that betrayal was already among them, wearing the same uniform, sharing the same rations, sleeping in the same barracks.",
    type: "alliance",
    side: "left",
    imageBg: scene(
  ...
  },
  {
    ...
    narration: "The 57th Exterior Scouting Mission was the Survey Corps' most ambitious operation — and its most catastrophic. The Female Titan appeared in the forest with impossible precision, targeting specifically the formation's center where Eren was concealed. She slaughtered dozens of scouts with brutal efficiency, capturing Eren after devastating the Long-Range Scouting Formation. Captain Levi's entire Special Operations Squad — the soldiers closest to him — were systematically murdered before his eyes. The expedition returned in ruins. The traitor wore human skin.",
    type: "battle",
    side: "right",
    imageBg: scene(
  ...
  },
  {
    ...
    narration: "The evidence assembled like an inescapable sentence: Annie Leonhart was the Female Titan. Levi and Hange cornered her in the Stohess District, deep within Wall Sina, where her escape routes were supposedly sealed. The confrontation was brief and devastating. Annie transformed, triggering a battle that tore through civilian streets. When Eren finally subdued her titan form, she encased herself in impenetrable crystal — a sleeping judgment, suspended in amber, beyond consequence. Her former squadmates looked at her frozen face and understood that some truths collapse everything around them.",
    type: "revelation",
    side: "left",
    imageBg: scene(
  ...
  },
  {
    ...
    narration: "No breach was found. Yet Titans were moving through Wall Rose territories with impossible freedom. The Survey Corps scattered to cover ground, track the incursion, and search for the gap that didn't exist. Connie Springer returned to his village and found it empty — except for a single immobile Titan, enormous and grotesque, lying atop his family home. Its face bore a horrifying resemblance to his mother. It smiled at him. In the accumulating horror of that silence, the first hypothesis formed: that Titans were not monsters born from outside, but humans transformed from within.",
    type: "revelation",
    side: "right",
    imageBg: scene(
  ...
  /* ── ARC VII ─────────────────────────────────── */
  {
    ...
    arcSubtitle: "Year 850 — Humanity reclaims its home. Legends forged in blood."
  },
  {
    kind: "event",
    id: "e17",
    ...
    narration: "The Survey Corps marched on Shiganshina with everything they had left — which was no longer very much. Erwin Smith delivered his final address before the charge, a speech that was less motivation than honest accounting: they would likely all die, but the truth in the Yeager basement justified the cost. They moved at night. They moved together. The plan was simple: Eren seals the breach with hardening, the Corps secures the city, and humanity takes back everything the Colossal Titan stole on that grey morning five years before. Simple plans rarely survive contact with the enemy.",
    type: "battle",
    side: "right",
    imageBg: scene(
  ...
  },
  {
    ...
    narration: "The Survey Corps that returned from Liberio was fractured beyond repair. Eren had acted unilaterally, without authorisation, and refused to explain his intentions. When Hange, Mikasa, and Armin confronted him, he disavowed their friendship with words designed to wound. He was imprisoned. Outside the jail walls, the Yeagerist faction — soldiers loyal to Eren's ideology over the military chain of command — began staging a revolution. Zeke Yeager waited somewhere inside the Walls, patient and purposeful. The organisation that had once been humanity's finest shield was eating itself from within.",
    type: "revelation",
    side: "right",
    imageBg: scene(
  ...
  },
  {
    ...
    narration: "In the space between life and death — the Paths, where all Titans converge — Eren and Zeke met. But Zeke's plan for euthanasia was not Eren's. Seizing the Founding Titan's power through direct contact with Ymir Fritz, Eren issued a single command to every Wall Titan simultaneously. The Walls crumbled. Hundreds of thousands of Colossal Titans emerged from their millennial tombs and began marching. The Rumbling — the threat that had kept the world at bay for a century — was no longer a deterrent. It was an apocalypse in motion, directed by a boy who had decided that freedom required the death of everyone outside Paradis.",
    type: "revelation",
    side: "right",
    imageBg: scene(
...
function ArcChapterMarker({ item }) {
  const ref = reactExports.useRef(null);
  const inView2 = useInView(ref, { once: true, margin: "-10% 0px -10% 0px" });
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            animate: inView2 ? { opacity: 1, scaleX: 1, filter: "blur(0px)" } : {},
            transition: { duration: 0.85, delay: 0.45, ease: [0.16, 1, 0.3, 1] },
            className: "relative z-10 px-8 py-4 text-center",
            style: {
              background: "linear-gradient(135deg, oklch(0.09 0 0 / 0.97), oklch(0.06 0 0 / 0.98))",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-3 left-3 z-10 flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
          ...
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: item.imageCaption
              }
            )
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0 w-8 h-8 overflow-hidden pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-3 right-3 opacity-30 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "w-0 h-0",
            style: {
...
function EventCard({
  ...
  const ref = reactExports.useRef(null);
  const inView2 = useInView(ref, { once: true, margin: "-5% 0px -5% 0px" });
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          ${isLeft ? "grid-cols-[3fr_2fr]" : "grid-cols-[2fr_3fr]"}
        `,
            style: { minHeight: "340px" },
            children: isLeft ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  className: "relative overflow-hidden",
                  initial: { opacity: 0, x: -64, filter: "blur(12px)" },
                  animate: inView2 ? { opacity: 1, x: 0, filter: "blur(0px)" } : {},
                  transition: { duration: 0.9, ease: [0.16, 1, 0.3, 1] },
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(ImagePanel, { item, typeCfg, arcCfg })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(NarrationPanel, { item, typeCfg, arcCfg })
                }
              )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-48", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ImagePanel, { item, typeCfg, arcCfg }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(NarrationPanel, { item, typeCfg, arcCfg })
            ]
          }
        )
      ]
...
function useCurrentArc() {
  const [current, setCurrent] = reactExports.useState("arc1");
  reactExports.useEffect(() => {
    const elements = document.querySelectorAll("[data-arc-id]");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grain-overlay absolute inset-0 pointer-events-none opacity-25" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "absolute inset-0 pointer-events-none",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-6xl mx-auto px-4 md:px-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "▸ MILITARY ARCHIVES — SURVEY CORPS — CLASSIFICATION LEVEL 5"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "cinematic-title text-3xl md:text-5xl lg:text-6xl mb-3 leading-none", children: "TIMELINE OF EVENTS" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      background: "linear-gradient(90deg, transparent, oklch(0.56 0.25 18), transparent)"
                    }
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "A classified record of pivotal moments — battles, betrayals, revelations, and sacrifices — that shaped the fate of Eldia and the world beyond the Walls. Each entry verified by the Intelligence Division."
                  }
                )
              ]
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                Object.entries(TYPE_CONFIG).map(([key, cfg]) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
                    ...
                    children: [
                      TIMELINE_ITEMS.filter((i) => i.kind === "event").length,
                      " EVENTS RECORDED"
                    ]
                  }
                )
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative", children: TIMELINE_ITEMS.map((item) => {
            if (item.kind === "arc") {
              return /* @__PURE__ */ jsxRuntimeExports.jsx(ArcChapterMarker, { item }, item.arcId);
            }
            const gIndex = ++eventIndex;
            return /* @__PURE__ */ jsxRuntimeExports.jsx(EventCard, { item, globalIndex: gIndex }, item.id);
          }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      background: "linear-gradient(90deg, transparent, oklch(0.56 0.25 18 / 0.45), transparent)"
                    }
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "END OF ARCHIVED RECORD — SURVEY CORPS INTELLIGENCE DIVISION"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "████ FURTHER RECORDS CLASSIFIED — LEVEL 7 CLEARANCE REQUIRED ████"
                  }
                )
              ]
            }
