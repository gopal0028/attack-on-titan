import { c as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, R as React, j as jsxRuntimeExports, m as motion, A as AnimatePresence, u as useStore } from "./index-B5x8QOC7.js";
function r(e3) {
  var t2, f2, n2 = "";
...
function _objectSpread$g(e3) {
  for (var r2 = 1; r2 < arguments.length; r2++) {
    var t2 = null != arguments[r2] ? arguments[r2] : {};
    r2 % 2 ? ownKeys$g(Object(t2), true).forEach(function(r22) {
      _defineProperty$h(e3, r22, t2[r22]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e3, Object.getOwnPropertyDescriptors(t2)) : ownKeys$g(Object(t2)).forEach(function(r22) {
...
var PolarAngles = function PolarAngles2(props) {
  ...
  return /* @__PURE__ */ React.createElement("g", {
    ...
    return /* @__PURE__ */ React.createElement("line", _extends$8({}, polarAnglesProps, {
...
var ConcentricCircle = function ConcentricCircle2(props) {
  ...
  return /* @__PURE__ */ React.createElement("circle", _extends$8({}, concentricCircleProps, {
...
var ConcentricPolygon = function ConcentricPolygon2(props) {
  ...
  return /* @__PURE__ */ React.createElement("path", _extends$8({}, concentricPolygonProps, {
...
var ConcentricPath = function ConcentricPath2(props) {
  ...
  return /* @__PURE__ */ React.createElement("g", {
    ...
    var key = i;
    if (gridType === "circle") return /* @__PURE__ */ React.createElement(ConcentricCircle, _extends$8({
      key
    }, props, {
      radius: entry,
      index: i
    }));
    return /* @__PURE__ */ React.createElement(ConcentricPolygon, _extends$8({
      key
    }, props, {
      radius: entry,
      index: i
...
var PolarGrid = function PolarGrid2(_ref) {
  ...
  return /* @__PURE__ */ React.createElement("g", {
  ...
  }, /* @__PURE__ */ React.createElement(PolarAngles, _extends$8({
    cx,
    cy,
    innerRadius,
    outerRadius,
    gridType,
    radialLines
  }, props)), /* @__PURE__ */ React.createElement(ConcentricPath, _extends$8({
    cx,
    cy,
    innerRadius,
    outerRadius,
  ...
  return _createClass$8(PolarAngleAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      if (axisLineType === "circle") {
        return /* @__PURE__ */ React.createElement(Dot, _extends$6({
      ...
      return /* @__PURE__ */ React.createElement(Polygon, _extends$6({
        className: "recharts-polar-angle-axis-line"
      }, props, {
        points
      }));
    ...
    value: function renderTicks() {
      ...
      var items = ticks2.map(function(entry, i) {
        ...
        return /* @__PURE__ */ React.createElement(Layer, _extends$6({
          ...
          key: "tick-".concat(entry.coordinate)
        }, adaptEventsOfChild(_this.props, entry, i)), tickLine && /* @__PURE__ */ React.createElement("line", _extends$6({
  ...
  return _createClass$7(Radar2, [{
    ...
    value: function renderPolygonStatically(points) {
      ...
      if (/* @__PURE__ */ React.isValidElement(shape)) {
        radar = /* @__PURE__ */ React.cloneElement(shape, _objectSpread$8(_objectSpread$8({}, this.props), {}, {
          points
        }));
        ...
        radar = /* @__PURE__ */ React.createElement(Polygon, _extends$5({}, filterProps(this.props, true), {
    ...
    value: function renderDotItem(option, props) {
      ...
      if (/* @__PURE__ */ React.isValidElement(option)) {
        ...
        dotItem = /* @__PURE__ */ React.createElement(Dot, _extends$5({}, dotProps, {
          key,
...
function StatBar({ label, value, delay = 0 }) {
  const colorClass = value >= 90 ? "from-primary to-accent" : value >= 70 ? "from-primary/80 to-accent/80" : "from-primary/60 to-accent/60";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "terminal-text text-muted-foreground text-xs tracking-widest", children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "terminal-text text-primary text-xs font-bold", children: value })
    ] }),
...
function RadarTooltip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass-panel border border-border/60 px-2 py-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "terminal-text text-primary text-xs", children: [
    subject,
    ": ",
    value
  ] }) });
...
function CharacterModal({
  ...
  const factionClass = FACTION_COLORS$1[character.faction] ?? "text-muted-foreground border-border bg-muted/20";
  const radarData = [
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            style: {
              boxShadow: "0 0 60px oklch(0.26 0.22 25 / 0.25), 0 0 0 1px oklch(0.26 0.22 25 / 0.15)",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary/20 border-b border-primary/40 px-6 py-2 flex items-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-primary animate-pulse flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "terminal-text text-primary text-xs tracking-[0.4em] truncate", children: "CLASSIFIED — ELDIAN MILITARY PERSONNEL FILE" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-auto terminal-text text-primary/50 text-xs hidden sm:inline flex-shrink-0", children: [
                  "ID: ",
                  character.id.toUpperCase()
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:w-2/5 relative bg-muted flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[3/4] lg:aspect-auto lg:h-full lg:min-h-[500px]", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                      src: character.image,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-transparent lg:to-card/70 hidden lg:block pointer-events-none" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-card via-transparent to-transparent lg:hidden pointer-events-none" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-4 left-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: `px-3 py-1.5 text-xs terminal-text font-bold border ${character.status === "Alive" ? "bg-accent/20 text-accent border-accent/40" : "bg-primary/20 text-primary border-primary/40"}`,
                      children: character.status === "Alive" ? "● ACTIVE" : "◆ KIA"
                    }
                  ) }),
                  character.titan && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-4 left-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-1 text-xs terminal-text bg-primary/30 text-primary border border-primary/50", children: "⚡ TITAN SHIFTER" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: "absolute inset-0 pointer-events-none opacity-5 hidden lg:block",
                      style: {
                        backgroundImage: "repeating-linear-gradient(0deg, transparent, transparent 2px, oklch(0.95 0 0) 2px, oklch(0.95 0 0) 3px)"
                      }
                    }
                  )
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-5 sm:p-6 space-y-5 min-w-0", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          children: character.faction.toUpperCase()
                        }
                      ),
                      character.titan && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-0.5 text-xs terminal-text bg-primary/20 text-primary border border-primary/40", children: "INHERITOR" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "cinematic-title text-3xl sm:text-4xl text-foreground leading-tight", children: character.name.toUpperCase() }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3 terminal-text text-muted-foreground text-xs tracking-wider", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "terminal-text text-primary text-xs tracking-widest", children: "// BIOGRAPHICAL SUMMARY" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed font-body", children: character.bio })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "terminal-text text-primary text-xs tracking-widest", children: "// KNOWN ABILITIES" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: character.abilities.map((ability) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      motion.span,
                      {
                        ...
                        children: ability.toUpperCase()
                      },
                      ability
                    )) })
                  ] }),
                  character.titan && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 p-3 border border-primary/30 bg-primary/5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "terminal-text text-primary text-xs tracking-widest", children: "// TITAN FORM" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "terminal-text text-accent text-sm", children: character.titan })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "terminal-text text-primary text-xs tracking-widest", children: "// COMBAT STATISTICS" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        StatBar,
                        {
                          label: "STRENGTH",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "terminal-text text-muted-foreground text-xs tracking-widest", children: "POPULARITY" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "terminal-text text-accent text-xs font-bold", children: character.popularity })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 bg-border rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          motion.div,
                          {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "terminal-text text-primary text-xs tracking-widest", children: "// POWER ANALYSIS" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-44", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(RadarChart, { data: radarData, outerRadius: "70%", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          PolarGrid,
                          {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: /* @__PURE__ */ jsxRuntimeExports.jsx(RadarTooltip, {}) })
                      ] }) }) })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-l-2 border-accent pl-4 space-y-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "terminal-text text-accent text-xs tracking-widest", children: "// FIELD QUOTE" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("blockquote", { className: "font-display text-sm italic text-foreground/80 leading-relaxed", children: [
                      '"',
                      character.quote,
                      '"'
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "terminal-text text-muted-foreground/50 text-xs", children: [
                      "— ",
                      character.name
                    ] })
                  ] })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-primary/10 border-t border-primary/20 px-6 py-2 flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "terminal-text text-primary/40 text-xs tracking-widest", children: "PROPERTY OF THE ELDIAN MILITARY — UNAUTHORIZED ACCESS PROHIBITED" }),
...
const CHARACTERS = [
  ...
  },
  {
    ...
    quote: "Don't patronize me. I've seen things that'd make your hair stand on end.",
  ...
  },
  {
    ...
    quote: "I've been a warrior. I've been a soldier. I've been everything between. I don't know who I am anymore.",
  ...
  },
  {
    ...
    quote: "I don't have any reason to go back to my hometown. But I still want to go back.",
  ...
  },
  {
    ...
    quote: "I'll inherit the Armored Titan! And I'll prove that we Eldians are worthy of living in Marley!",
...
function MiniStatBar({ label, value }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-0.5 bg-border rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
...
function CharacterCard({
  ...
  const factionClass = FACTION_COLORS[character.faction] ?? "text-muted-foreground border-border bg-muted/20";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.button,
    {
      type: "button",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[3/4] overflow-hidden bg-muted", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `absolute top-2 right-2 px-2 py-0.5 text-xs terminal-text font-bold ${character.status === "Alive" ? "bg-accent/20 text-accent border border-accent/40" : "bg-primary/20 text-primary border border-primary/40"}`,
              children: character.status === "Alive" ? "● ACTIVE" : "◆ KIA"
            }
          ),
          character.titan && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2 left-2 px-1.5 py-0.5 text-xs terminal-text bg-primary/30 text-primary border border-primary/50", children: "⚡ SHIFTER" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MiniStatBar, { label: "STRENGTH", value: character.stats.strength }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    MiniStatBar,
                    {
                      label: "INTELLIGENCE",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MiniStatBar, { label: "SPEED", value: character.stats.speed }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    MiniStatBar,
                    {
                      label: "LEADERSHIP",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 pt-2 border-t border-border/40", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    className: "terminal-text text-muted-foreground text-center",
                    style: { fontSize: "0.55rem", letterSpacing: "0.2em" },
                    children: "CLICK TO ACCESS FULL DOSSIER"
                  }
                ) })
              ]
            }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "cinematic-title text-sm text-foreground leading-tight", children: character.name.toUpperCase() }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                children: character.rank.toUpperCase()
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            style: {
              boxShadow: hovered ? "inset 0 0 20px oklch(0.26 0.22 25 / 0.08)" : "none"
            }
          }
        )
      ]
...
function CharactersSection() {
  ...
  const filtered = CHARACTERS.filter((c2) => {
    if (characterFilters.status !== "all" && c2.status !== characterFilters.status)
      return false;
    if (characterFilters.faction.length > 0 && !characterFilters.faction.includes(c2.faction))
      return false;
    if (characterFilters.titanType === "titan-shifter" && !c2.titan)
      return false;
    if (characterFilters.titanType === "human" && c2.titan) return false;
    if (characterFilters.search && !c2.name.toLowerCase().includes(characterFilters.search.toLowerCase()))
      return false;
    return true;
  }).sort((a2, b2) => {
    if (characterSort === "popularity") return b2.popularity - a2.popularity;
    if (characterSort === "name") return a2.name.localeCompare(b2.name);
    return b2.stats[characterSort] - a2.stats[characterSort];
  });
  ...
  const toggleFaction = reactExports.useCallback(
    (faction) => {
      const active = characterFilters.faction.includes(faction);
      setCharacterFilters({
        faction: active ? characterFilters.faction.filter((f2) => f2 !== faction) : [...characterFilters.faction, faction]
      });
    },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
            ...
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-gradient-to-r from-transparent to-primary/50" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "terminal-text text-primary text-xs tracking-[0.5em]", children: "◉ CLASSIFIED ◉" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-gradient-to-l from-transparent to-primary/50" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative inline-block", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "h2",
                      {
                        ...
                        children: "INTELLIGENCE DOSSIER"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-2 -right-4 hidden sm:block rotate-[-12deg] border-2 border-primary/60 px-3 py-1 opacity-70", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: "terminal-text text-primary",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "terminal-text text-muted-foreground text-xs tracking-[0.4em]", children: "ELDIAN MILITARY — PERSONNEL FILES — CLEARANCE LEVEL: ALPHA" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "terminal-text text-primary/60 text-xs", children: `[ ${CHARACTERS.length} RECORDS ON FILE · ${filtered.length} MATCHES ACTIVE QUERY ]` })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "terminal-text text-muted-foreground text-xs tracking-widest mr-2 hidden sm:inline", children: "SORT BY:" }),
                SORT_OPTIONS.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
                    onClick: () => setCharacterSort(opt.value),
                    "data-ocid": `characters.sort_${opt.value}`,
                    className: `px-3 py-1.5 text-xs terminal-text border transition-all duration-200 ${characterSort === opt.value ? "border-primary bg-primary/20 text-primary" : "border-border text-muted-foreground hover:border-muted-foreground hover:text-foreground"}`,
                    children: [
                      characterSort === opt.value && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mr-1", children: "▶" }),
                      opt.label
                    ]
                  },
                  opt.value
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: showFilters ? "▲ FILTERS" : "▼ FILTERS"
                  }
                ) })
              ]
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: showFilters && /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-panel border border-border/50 p-4 space-y-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3 items-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-48 relative", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        ...
                        onChange: (e3) => setCharacterFilters({ search: e3.target.value }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "select",
                    {
                      ...
                      onChange: (e3) => setCharacterFilters({
                        status: e3.target.value
                      }),
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Alive", children: "● ALIVE" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "Dead", children: "◆ DECEASED" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "select",
                    {
                      ...
                      onChange: (e3) => setCharacterFilters({
                        titanType: e3.target.value
                      }),
                      className: "bg-background border border-border px-3 py-2 terminal-text text-muted-foreground text-xs focus:outline-none focus:border-primary transition-colors",
                      "data-ocid": "characters.type_select",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "all", children: "ALL TYPES" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "titan-shifter", children: "⚡ TITAN SHIFTERS" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "human", children: "◯ HUMAN ONLY" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 items-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "terminal-text text-muted-foreground/50 text-xs tracking-widest mr-1", children: "FACTION:" }),
                  ALL_FACTIONS.map((faction) => {
                    const active = characterFilters.faction.includes(faction);
                    const colorClass = FACTION_COLORS[faction] ?? "text-muted-foreground border-border";
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        type: "button",
                        ...
                        className: `px-3 py-1 text-xs terminal-text border transition-all duration-200 ${active ? colorClass : "border-border text-muted-foreground hover:border-muted-foreground"}`,
                        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "popLayout", children: filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 border border-primary/30 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "terminal-text text-primary text-2xl", children: "⚠" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "terminal-text text-primary text-xs tracking-widest", children: "NO RECORDS FOUND" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "terminal-text text-muted-foreground text-sm", children: "Adjust filters to search the personnel database." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
            ...
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "popLayout", children: filtered.map((char, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(CharacterCard, { character: char, index: i }, char.id)) })
            },
            "grid"
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "terminal-text text-muted-foreground/40 text-xs tracking-widest", children: `DISPLAYING ${filtered.length}/${CHARACTERS.length} RECORDS` }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-border/40" })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: selectedCharacter && /* @__PURE__ */ jsxRuntimeExports.jsx(
          CharacterModal,
          {
