...
// ── Extended quote data ────────────────────────────────────────────────────────
interface AotQuote extends Quote {
  bgGradient: string;
  accentColor: string;
}

const QUOTES: AotQuote[] = [
  {
    text: "If you win, you live. If you lose, you die. If you don't fight, you can't win!",
    author: "Eren Yeager",
    arc: "Battle of Trost",
    bgGradient:
      "radial-gradient(ellipse at 60% 40%, oklch(0.18 0.14 22) 0%, oklch(0.06 0.04 15) 60%)",
  ...
  },
  {
    ...
    arc: "Trost Arc",
    bgGradient:
      "radial-gradient(ellipse at 40% 50%, oklch(0.14 0.06 220) 0%, oklch(0.06 0 0) 65%)",
  ...
  },
  {
    ...
    arc: "Before the Fall",
    bgGradient:
      "radial-gradient(ellipse at 50% 60%, oklch(0.16 0.1 20) 0%, oklch(0.05 0.02 15) 65%)",
  ...
  },
  {
    ...
    bgGradient:
      "radial-gradient(ellipse at 55% 35%, oklch(0.15 0.05 55) 0%, oklch(0.06 0.01 30) 65%)",
  ...
  },
  {
    ...
    arc: "Marley Arc",
    bgGradient:
      "radial-gradient(ellipse at 45% 55%, oklch(0.14 0.06 60) 0%, oklch(0.06 0.02 40) 65%)",
  ...
  },
  {
    ...
    bgGradient:
      "radial-gradient(ellipse at 50% 40%, oklch(0.12 0.04 200) 0%, oklch(0.05 0.01 180) 65%)",
  ...
  },
  {
    ...
    arc: "War for Paradis",
    bgGradient:
      "radial-gradient(ellipse at 60% 50%, oklch(0.20 0.18 18) 0%, oklch(0.06 0.05 12) 65%)",
  ...
  },
  {
    ...
    bgGradient:
      "radial-gradient(ellipse at 40% 60%, oklch(0.14 0.08 30) 0%, oklch(0.06 0.03 20) 65%)",
  ...
  },
  {
    ...
    arc: "The Uprising",
    bgGradient:
      "radial-gradient(ellipse at 55% 45%, oklch(0.16 0.07 80) 0%, oklch(0.06 0.02 60) 65%)",
  ...
  },
  {
    ...
    arc: "War for Paradis",
    bgGradient:
      "radial-gradient(ellipse at 50% 50%, oklch(0.14 0.05 90) 0%, oklch(0.06 0.01 70) 65%)",
  ...
  },
  {
    ...
    bgGradient:
      "radial-gradient(ellipse at 50% 50%, oklch(0.16 0.12 20) 0%, oklch(0.04 0.02 10) 60%)",
  ...
  },
  {
    ...
    bgGradient:
      "radial-gradient(ellipse at 50% 40%, oklch(0.18 0.08 50) 0%, oklch(0.06 0.02 35) 65%)",
    ...
    >
      ...
      <AnimatePresence>
        {isTransitioning && (
          <motion.div
            ...
            style={{
              background:
                "repeating-linear-gradient(0deg, transparent, transparent 2px, oklch(0.26 0.22 25 / 0.07) 2px, oklch(0.26 0.22 25 / 0.07) 4px)",
            }}
            aria-hidden="true"
          />
        )}
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        ...
        >
          ...
          />
          <p className="terminal-text text-xs uppercase tracking-[0.3em] text-muted-foreground">
            Field Intelligence Logs
          </p>
          <div
            className="h-px flex-1 max-w-20"
            style={{ background: quote.accentColor, opacity: 0.5 }}
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {/* Quote text */}
            <blockquote className="font-display text-xl md:text-3xl lg:text-4xl font-bold text-foreground leading-tight mb-8">
          ...
          {QUOTES.map((q, i) => (
            <button
              ...
              style={{
                ...
                height: 6,
                background:
                  i === index ? quote.accentColor : "oklch(var(--muted))",
              }}
